...
public class MobileDriverNamedParameter {
	...
	public static void main(String[] args) {
		...
		et.begin();
//		Query query3 = em.createQuery("Delete from Mobile where id=:hojaDelte");
//		System.out.println("Enter id to delete");
//		int id = sc.nextInt();
//		query3.setParameter("hojaDelte", id);
//		System.out.println("updated");
		
		Query query2 = em.createQuery("from Mobile  where id=:namBata");
		//1		Object singleResult = query2.getSingleResult();	/// return type is Object
//				System.out.println(singleResult);
		int naam = sc.nextInt();
		query2.setParameter("namBata", naam);
